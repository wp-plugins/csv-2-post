...
class C2P_TabMenu {
    public function menu_array() {
        ...
        // adoption
        $menu_array['adoption']['groupname'] = 'postcreation';
        $menu_array['adoption']['slug'] = 'csv2post_adoption';// home page slug set in main file
        $menu_array['adoption']['menu'] = __( 'Adoption', 'csv2post' );// main menu title
        $menu_array['adoption']['pluginmenu'] = __( 'Adoption', 'csv2post' );// main menu title
        $menu_array['adoption']['name'] = "adoption";// name of page (slug) and unique
        $menu_array['adoption']['title'] = __( 'Advanced Adoption', 'csv2post' );// page title seen once page is opened 
        $menu_array['adoption']['parent'] = 'postcreation';// either "parent" or the name of the parent - used for building tab menu   
        $menu_array['adoption']['tabmenu'] = true;
