    ...
    */
    ...
    function csv2post_register_admin_styles() {
        ...
        if(isset($csv2post_guitheme) && $csv2post_guitheme == 'jquery'){
            ...
            wp_register_style('csv2post_jquery_styles',plugins_url(WTG_C2P_FOLDERNAME.'/css/jquerythemes/start/jquery-ui-1.8.17.custom.css'), array(), '1.0.0', 'screen');
        }
        
        // WebTechGlobal styles
        wp_register_style('csv2post_css_notification',plugins_url(WTG_C2P_FOLDERNAME.'/css/notifications.css'), array(), '1.0.0', 'screen');
        wp_register_style('csv2post_css_admin',plugins_url(WTG_C2P_FOLDERNAME.'/css/admin.css'), __FILE__);
        wp_register_style('csv2post_css_global',plugins_url(WTG_C2P_FOLDERNAME.'/css/global.css'), __FILE__);

        // widgets
        wp_register_style('csv2post_css_jquerymultiselect',plugins_url(WTG_C2P_FOLDERNAME.'/script/multiselect/jquery.multiselect.css'), __FILE__);
        wp_register_style('csv2post_css_jquerymultiselect_prettify',plugins_url(WTG_C2P_FOLDERNAME.'/script/multiselect/assets/prettify.css'), __FILE__);
        wp_register_style('csv2post_css_jquerymultiselect_filter',plugins_url(WTG_C2P_FOLDERNAME.'/script/multiselect/jquery.multiselect.filter.css'), __FILE__);
        wp_register_style('csv2post_css_jquerymulti-select',plugins_url(WTG_C2P_FOLDERNAME.'/css/jquery.multi-select.css'), __FILE__);            
    }
