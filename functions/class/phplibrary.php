...
class C2P_PHP extends C2P_Notice {
    /**
    ...
    */
    public function arrayinfo_set($array,$line,$function,$file){
        ...
        $array['arrayinfo']['date'] = $C2P_WP->datewp();
        return $array;   
    }  
    /**
    ...
    */
    public function type($value){
        ...
        // is email address
        if($C2P_WP->is_valid_emailaddress($value)){
            return 'email';
        }                  
    ...
    */
    public function months_time_range($month,$year,$return = 'array',$format = 'time'){
        ...
        if($format == 'date')
        {
            $array['start'] = $C2P_WP->datewp(0,$array['start']);
        }
        ...
        if($format == 'date')
        {    
            $array['end'] = $C2P_WP->datewp(0,$array['end']);   
        }
