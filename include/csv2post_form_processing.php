...
if($cont){
    ...
    // Save URL Cloaking 
    $cont = csv2post_form_save_urlcloaking();
}
...
function csv2post_form_ECI_paid_step18_createposts(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidcreateposts' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
//$csv2post_ecisession_array['nextstep'] = 19;
        ...
        $post_id = csv2post_create_posts_advanced($csv2post_currentproject_code,'manual');
        if($post_id){
...
function csv2post_form_ECI_paid_step17_posttypes(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidposttypes' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step15_authors(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaiddefaultauthor' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
        global $csv2post_project_array,$csv2post_currentproject_code;
...
function csv2post_form_ECI_paid_step13_tags(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidtags' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){

        $csv2post_ecisession_array = csv2post_WP_SETTINGS_get_eciarray();
                
        if($_POST['csv2post_eci_paidtags_methods'] == 'no'){
            ...
            $csv2post_project_array['tags']['default']['column'] = $_POST['csv2post_eci_paidtags_methods'];                       
...
function csv2post_form_ECI_paid_step12_images(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidimages' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step10_categories(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidcategories' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step9_customfields(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidcustomfields' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step8_postdates(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidpostdates' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
        ...
        if($_POST['csv2post_eci_paiddates_methods'] == 'default'){
            
            unset($csv2post_project_array['dates']['currentmethod']);
             
        }elseif($_POST['csv2post_eci_paiddates_methods'] == 'data'){
            
            $csv2post_project_array['dates']['date_column']['table_name'] = 'csv2post_' . $csv2post_ecisession_array['dijcode'];          
            $csv2post_project_array['dates']['date_column']['column_name'] = $_POST['csv2post_csvfileheader_eci_paiddates_' . $file];
...
function csv2post_form_ECI_paid_step7_poststatus(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidpoststatus' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
        global $csv2post_project_array,$csv2post_currentproject_code;
...
function csv2post_form_ECI_paid_step5_titletemplate(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidsetuptitletemplate' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step4_contenttemplate(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidsetupcontenttemplate' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step3_importdate(){
    if(isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidimportdata' && isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main'){
...
function csv2post_form_ECI_paid_step2_confirmformat(){
    if(isset( $_POST['csv2post_hidden_pageid'] ) && $_POST['csv2post_hidden_pageid'] == 'main' && isset($_POST['csv2post_hidden_panel_name']) && $_POST['csv2post_hidden_panel_name'] == 'ecipaidconfirmformat'){
...
function csv2post_form_save_urlcloaking(){
    if(isset($_POST[WTG_C2P_ABB.'hidden_pageid']) && $_POST[WTG_C2P_ABB.'hidden_pageid'] == 'projects' && isset($_POST[WTG_C2P_ABB.'hidden_panel_name']) && $_POST[WTG_C2P_ABB.'hidden_panel_name'] == 'projectcloakingsettings'){
        global $csv2post_currentproject_code,$csv2post_project_array;
        
        if(isset($csv2post_project_array['urlcloaking'])){
            unset($csv2post_project_array['urlcloaking']);
        }
        
        $nextKey = 0;
             
        foreach($_POST['csv2post_cloakcolumns'] as $TableColumn){

            $csv2post_project_array['urlcloaking'][$nextKey]['table'] = csv2post_explode_tablecolumn_returnnode(',',0,$TableColumn);    
            $csv2post_project_array['urlcloaking'][$nextKey]['column'] = csv2post_explode_tablecolumn_returnnode(',',1,$TableColumn); 
            
            $nextKey = csv2post_get_array_nextkey($csv2post_project_array['urlcloaking']);           
        }

        csv2post_update_option_postcreationproject($csv2post_currentproject_code,$csv2post_project_array);
   
        csv2post_n_postresult('success','URL Cloaking Setup','Please remember your URL data will not
        be in your post content and instead stored in custom fields. Have you considered using CSV 2 POST
        to do regular checks on your URL data and deal with any broken links by flagging the posts using them?');
