...
function csv2post_WP_SQL_create_dataimportjob_table($jobcode,$job_file_group,$maintableonly = false){
    ...
    */
    ...
    if( $createresult1 ){
        ...
        csv2post_notice('Database query not correct. Usually this is due to incorrect separator, quote or number of 
        ...
        'error','Small','Possible Incorrect Separator or Quote','http://www.csv2post.com/notifications/database-query-failure-on-creating-data-import-job','echo','');
        return false;
    }        
}
