...
if(is_admin()){require_once(WTG_C2P_DIR.'include/webservices/csv2post_api_tickets.php');}
...
* @todo CRITICAL, causing SOAP response error 
*/
function csv2post_SOAP_webservices_status_call(){
    ...
    return csv2post_SOAP_response( $soapcall_result_array );   
}
...
*/
function csv2post_SOAP_response( $soapcall_result_array ){
...
* @return array,
*/
function csv2post_SOAP_validate_call_code($callcode){
    $client = new SoapClient(null, array(
...
* @return array, $soapcall_result_array
*/
function csv2post_SOAP_confirm_current_domain_is_registered(){
...
*/
function csv2post_SOAP_checksubscriptionstatus_for_domain(){
...
*/
function csv2post_SOAPi_is_activationcodevalid_soapcall( $activationcode ){
    $client = new SoapClient(null, array(
...
*/
function csv2post_SOAP_allowed(){
...
* @param mixed $state
*/
function csv2post_SOAP_update_apikeysession($seconds,$state){
