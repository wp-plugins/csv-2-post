...
<a href="http://pro.csv2post.com" title="Buy CSV 2 POST Plus" target="_blank">Try CSV 2 POST Online Demo</a><br />
...
if((isset($_POST['stage']) && $_POST['stage'] == 6) || (isset($stage5complete) && $stage5complete == true))
{
	...
	if( $count > 0 )
	{
		...
		<p><a href="http://pro.csv2post.com" title="Go to paid edition demo"><strong>Go To Paid Edition Demo</strong></a></p>
