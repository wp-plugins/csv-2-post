...
<?php csv2post_panel_header( $panel_array );?>
    ...
    if(!isset($csv2post_project_array['categories'])){
        ...
        echo csv2post_notice('No category settings have been saved for your current project. You must save some 
        category settings and this test feature will use those settings.','warning','Large','No Category Settings','','return');
