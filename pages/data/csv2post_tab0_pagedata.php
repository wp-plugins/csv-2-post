...
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
$panel_array['video'] = 'http://www.youtube.com/embed/58WipF9Vo98';
    ...
    jQuery(document).ready(function(){
        ...
        $("#<?php echo $jobname_id;?>").change(function() { 
            ...
            if(usr.length >= 4){
                ...
                jQuery.ajax({
                    type: "post",url: "admin-ajax.php",data: { action: 'action_createdataimportjobcsvfiles_validatefield', csv2post_jobname: escape( jQuery( '#<?php echo $jobname_id;?>' ).val() ), _ajax_nonce: '<?php echo $nonce; ?>' },
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    <h4>File Status</h4>
    <?php csv2post_csv_files_status_list();?>
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    <script>
        $(function() {
            $( "#csv2post_separators_<?php echo $panel_array['panel_name'];?>" ).buttonset();
        });
    </script>

    <h2>Select Files Separator</h2>
    <div id="csv2post_separators_<?php echo $panel_array['panel_name'];?>">
        <input type="radio" id="csv2post_separator_radio1<?php echo $panel_array['panel_name'];?>" name="csv2post_testcsvfile_separator_radiogroup" value="," /><label for="csv2post_separator_radio1<?php echo $panel_array['panel_name'];?>">,</label>
        <input type="radio" id="csv2post_separator_radio2<?php echo $panel_array['panel_name'];?>" name="csv2post_testcsvfile_separator_radiogroup" value=";" /><label for="csv2post_separator_radio2<?php echo $panel_array['panel_name'];?>">;</label>
...
if($csv2post_is_dev){
    ...
    <?php csv2post_panel_header( $panel_array );?>
        ...
        <h4>Entire Array</h4>
        <?php csv2post_var_dump($csv2post_job_array);?>
    ...
    <?php csv2post_panel_header( $panel_array );?>
        ...
        <h4>Entire Array</h4>
        <?php csv2post_var_dump($csv2post_dataimportjobs_array);?>
    ...
    <?php csv2post_panel_header( $panel_array );?>
        ...
        <h4>Entire Array</h4>
        <?php csv2post_var_dump($csv2post_jobtable_array);?>
