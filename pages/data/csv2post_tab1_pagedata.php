            ...
            <!-- Start Of Buttons Table --> 
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><strong>Already Imported</strong><input type='text' name='thevalue' id='thevalue_<?php echo $jobcode . $csv_filename_cleaned;?>' value='<?php echo csv2post_WP_SQL_count_records_forfile('csv2post_'.$jobcode,$csv_filename,$key); ?>' size="10" readonly /> </td>
                    </tr>
                </table>
                <?php }?>
                    ...
                    foreach($job_array['files'] as $key => $csv_filename){ 
                        ...
                        <tr>
                            <td>';
                                ...
                                <script>
                                $(function() {
                                    $( "#csv2post_importselection_<?php echo $object_type;?>_<?php echo $jobcode;?>" ).buttonset();
                                });
                                </script>

                                <div id="csv2post_importselection_<?php echo $object_type;?>_<?php echo $jobcode;?>">                    
                                    <input type="<?php echo $object_type;?>" name="csv2post_importselection_csvfiles[]" id="csv2post_importselection_csvfiles<?php echo $jobcode;?>" value="<?php echo $csv_filename;?>" checked />
                                    <label for="csv2post_importselection_csvfiles<?php echo $jobcode;?>">*</label>                     
                                </div>
