...
<?php csv2post_panel_header( $panel_array );?> 
    ...
    <?php echo wtgcore_notice( '98 Rows Imported Successfully From filexample.csv','success','Tiny','','','return');?>
    <?php echo wtgcore_notice( '1 Row Import Failure fileexample.csv','error','Tiny','','','return');?>
    <?php echo wtgcore_notice( '1 Row Import Warning: your data import rules have blackmarked the row','warning','Tiny','','','return');?>
    <?php echo wtgcore_notice( '2000 Rows Imported Successfully','success','Tiny','','','return');?> 
    <?php echo wtgcore_notice( '677 Rows Imported Successfully','success','Tiny','','','return');?> 
