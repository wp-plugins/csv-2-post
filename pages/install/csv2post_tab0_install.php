...
### TODO:HIGHPRIORITY, use csv2post_was_installed to create a more dynamic message 
            ...
            csv2post_notice(__('The plugin has not been installed, please use the First-Time Install feature above to begin using it.'), 'info', 'Extra', false);
            ...
            <div class="<?php echo WTG_C2P_ABB;?>boxcontent_div">
                ...
                if($csv2post_requirements_missing == true ){
                   ...
                   csv2post_notice(__('Re-Install options have been hidden as your Wordpress installation does not meet requirements for this plugin to operate properly. The reason should be displayed in another message above.'),'info','Large',false);
               ...
               }elseif($csv2post_requirements_missing == false && $conflict_found == false){
                    ...
                    $jsform_set['dialoguebox_title'] = 'Re-Installing '.WTG_C2P_PLUGINTITLE;
                    // wtg notice box display
                    $jsform_set['noticebox_content'] = __('Do you want to re-install '.WTG_C2P_PLUGINTITLE.' by deleting all existing installed parts then re-installing them?');

                    csv2post_formstart_standard($jsform_set['form_name'],$jsform_set['form_id'],'post','csv2post_form','');?>

                    <?php csv2post_jquery_graphiccheckboxes();?>
                    ...
                    <fieldset>
                            ...
                            <ul class="checklist">
                                ...
                                $i = 0;
                                $exclusions = array(WTG_C2P_ABB . 'was_installed');// this is never removed, helps to indicate plugin has been used on blog but we dont show it too user
                                foreach( $csv2post_options_array as $arraykey => $parameter){
        ...
        if(!$csv2post_is_installed){
            ...
            <div class="<?php echo WTG_C2P_ABB;?>boxcontent_div">
                <?php
                    ...
                    // make require alterations to form settings
                    $jsform_set['has_options'] = true;// true or false (controls output of selected settings
                    $jsform_set['dialoguebox_title'] = 'Un-Installing '.WTG_C2P_PLUGINTITLE;
                    // wtg notice box display
                    $jsform_set['noticebox_content'] = 'Do you want to un-install some or all of '.WTG_C2P_PLUGINTITLE.'?';
