...
<?php csv2post_panel_header( $panel_array );?>
    ...
    <ul>
        ...
        <li><strong>WTG_C2P_CONURL</strong> <?php echo WTG_C2P_CONURL;?></li>                      
...
<?php csv2post_panel_header( $panel_array );?>
    <ul>
        ...
        <li><strong>Encoding Clean String:</strong> <?php echo csv2post_encoding_clean_string('åöÄ'); ?></li>
        <li><strong>UTF-8 Encode:</strong> <?php echo utf8_encode('beta testing only åöÄ'); ?></li>        
        <li><strong>UTF-8 Encode (special characters only):</strong> <?php echo utf8_encode('åöÄ'); ?></li>
        <li><strong>UTF-8 Decode (special characters only):</strong> <?php echo utf8_decode('åöÄ'); ?></li>
    </ul>        
<?php csv2post_panel_footer();?> 
