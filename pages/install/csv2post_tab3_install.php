...
$panel_array['panel_intro'] = __('Displays details about your server that are important to '.WTG_C2P_PLUGINTITLE.'.');
$panel_array['panel_help'] = __('The list of information indicates configuration important to this software and in some cases will indicate the status of an item i.e. if a required extension is not installed on your server and required for '.WTG_C2P_PLUGINTITLE.' to operate properly this will be made clear.'); 
