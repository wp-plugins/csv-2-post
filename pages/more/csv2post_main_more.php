<?php 
global $csv2post_file_profiles,$csv2post_mpt_arr,$wpdb,$csv2post_options_array,$csv2post_nav_type,$csv2post_is_free,$csv2post_plugintitle;
...
wtgcore_notice('Most of the More screen will be under construction until 2013 as some of the features still require Web Services (SOAP) to be fully developed and tested.','warning','Large');
