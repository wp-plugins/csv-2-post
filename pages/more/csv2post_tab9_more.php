...
<div id="titles" class="postbox">
    ...
    if($contactreason == 'pluginhelp'){
        ...
        $panel_array['panel_intro'] = 'Contact the developer of '.WTG_C2P_PLUGINTITLE.' for support or general questions';
