...
<?php csv2post_panel_header( $panel_array );?>
    ...
    <?php 
    global $csv2post_debug_mode,$csv2post_is_dev,$csv2post_plugintitle,$csv2post_pluginname,$csv2post_homeslug,$csv2post_isbeingactivated,$csv2post_disableapicalls,$csv2post_is_event,$csv2post_installation_required,$csv2post_apiservicestatus,$csv2post_is_webserviceavailable,$csv2post_is_subscribed,$csv2post_was_installed,$csv2post_is_domainregistered,$csv2post_is_emailauthorised,$csv2post_log_maindir,$csv2post_callcode;
    ?>
