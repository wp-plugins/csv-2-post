...
######################################################## 
    ...
    require_once(WTG_C2P_DIR.'templatesystem/include/variables/csv2post_variables_update_array.php');
...
if($display_main_screens){
    ...
    if($csv2post_nav_type == 'css'){### TODO:CRITICAL, complete css menu 
    ...
    }elseif($csv2post_nav_type == 'nonav'){### TODO:CRITICAL, complete no navigation view
