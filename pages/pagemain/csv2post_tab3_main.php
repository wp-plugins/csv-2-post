...
if(!$csv2post_extension_loaded){?>
    <iframe width="560" height="315" src="http://www.youtube.com/embed/xVmrPMt9SMQ" frameborder="0" allowfullscreen></iframe><?php 
}?>
...
<p>Experts in all areas of Web Design and Internet Development have helped to shape CSV 2 POST. Their
requests related to SEO, data management and far more advanced features. Has ensured that CSV 2 POST is on the 
right path to becoming the ultimate CSV importer for Wordpress. If your not using a plugin as advanced as CSV 2 POST,
