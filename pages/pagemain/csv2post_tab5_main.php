...
<?php csv2post_panel_header( $panel_array );?> 
    ...
    require( WTG_C2P_DIR . 'wtg-wordpress-core/arrays/wtgcore_array_capabilities.php' );
    ...
    foreach($csv2post_mpt_arr['menu'] as $page_name => $page_array){
        ...
        foreach($page_array['tabs'] as $key => $tab_array){
            ...
            if(isset($tab_array['display']) && $tab_array['display'] != false){
                ...
                echo '<td>' . csv2post_SETTINGS_get_tab_capability($page_name,$key,true). '</td>';
                
                echo '<td>';

                csv2post_FORM_menu_capabilities($csv2post_ARRAY_capabilities,$page_name,$key,csv2post_SETTINGS_get_tab_capability($page_name,$key,false));     
...
<?php csv2post_panel_header( $panel_array );?> 
    ...
    foreach($csv2post_mpt_arr['menu'] as $page_name => $page_array){
        ...
        echo '<td>' . csv2post_SETTINGS_get_page_capability($page_name,true). '</td>';
        
        echo '<td>';

        csv2post_FORM_menu_capabilities($csv2post_ARRAY_capabilities,$page_name,99,csv2post_SETTINGS_get_page_capability($page_name,$key,false));     
