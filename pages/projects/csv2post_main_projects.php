<?php      
global $csv2post_guitheme,$csv2post_is_dev,$csv2post_mpt_arr,$wpdb,$csv2post_options_array,$csv2post_projectslist_array,$csv2post_currentproject_code,$csv2post_project_array,$csv2post_is_free,$csv2post_textspin_array;
