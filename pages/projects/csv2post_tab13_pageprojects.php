...
if($csv2post_is_dev && isset($csv2post_project_array)){
    ...
    <?php csv2post_panel_header( $panel_array );?>
        ...
        if(!isset($csv2post_project_array['custom_fields'])){
            ...
            echo '<pre>';
            var_dump($csv2post_project_array['custom_fields']);
            echo '</pre>';
        }?>
        ...
        if(!isset($csv2post_project_array['stats'])){
            ...
            echo '<pre>';
            var_dump($csv2post_project_array['stats']);
            echo '</pre>';
        }?>   
        ...
        if(!isset($csv2post_project_array['dates'])){
            ...
            echo '<pre>';
            var_dump($csv2post_project_array['dates']);
            echo '</pre>';
        }?> 
        ...
        if(!isset($csv2post_project_array['posttyperules'])){
            ...
            echo '<pre>';
            var_dump($csv2post_project_array['posttyperules']);
            echo '</pre>';    
        }?>
        ...
        if(!isset($csv2post_project_array['categories'])){
            ...
            echo '<pre>';
            var_dump($csv2post_project_array['categories']);
            echo '</pre>';    
        }?>        
        ...
        <?php 
        echo '<pre>';
        var_dump($csv2post_project_array);
        echo '</pre>';?>
