...
<?php csv2post_panel_header( $panel_array );?>
    ...
    csv2post_formend_standard('Use Wordpress Default Publish Dates',$jsform_set['form_id']);?>
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    // add end of form - dialogue box does not need to be within the <form>
    csv2post_formend_standard('Use Dates Data',$jsform_set['form_id']);?>
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    // add end of form - dialogue box does not need to be within the <form>
    csv2post_formend_standard('Use Incremental Dates Method',$jsform_set['form_id']);?>
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    // add end of form - dialogue box does not need to be within the <form>
    csv2post_formend_standard('Use Random Dates Method',$jsform_set['form_id']);?>
