...
$panel_array['panel_help'] = __('Upload a new .csv file to the plugins own content folder. 
This file uploader allows .csv files to be uploaded to the plugins own content folder which
 you will find in the wp-content directory.');
