...
$panel_array['panel_title'] = __('Step 13: Tags');// user seen panel header text 
$panel_array['panel_id'] = $panel_array['panel_name'].$panel_number;// creates a unique id, may change from version to version but within a version it should be unique
$panel_array['panel_intro'] = __('Select your column that holds pre-made tags');
$panel_array['help_button'] = csv2post_helpbutton_text(false,false);
$panel_array['panel_help'] = __('Tags are optional. Your tags must be comma separated (this can be hacked).');
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    if($csv2post_ecisession_array['nextstep'] > 13){
        ...
        <div id="csv2post_eci_freetags_switch">
            <input type="radio" id="csv2post_eci_freetags_no" name="csv2post_eci_freetags_methods" value="no" /><label for="csv2post_eci_freetags_no">Do Not Create Tags</label>
