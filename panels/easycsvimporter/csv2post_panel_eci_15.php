...
$panel_array['panel_intro'] = __('Select the author you would like your posts to be assigned to');
$panel_array['help_button'] = csv2post_helpbutton_text(false,false);
$panel_array['panel_help'] = __('You may assign any user as the author of your posts.');
...
<?php csv2post_panel_header( $panel_array );?>
    ...
    if($csv2post_ecisession_array['nextstep'] > 15){
        ...
        <?php 
        echo csv2post_SETTINGS_form_submit_dialog($panel_array);
