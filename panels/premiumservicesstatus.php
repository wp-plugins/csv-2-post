        ...
        if(!$csv2post_is_installed){
            ...
            <div class="csv2post_boxcontent_div">
                ...
                if($csv2post_apiservicestatus){
                    echo '<img src="'.WTG_C2P_URL.'fulledition/images/statusbanners/webservicebanners/webtechglobal-webservice-online.jpg"/>';                        
                }else{
                    echo '<img src="'.WTG_C2P_URL.'fulledition/images/statusbanners/webservicebanners/webtechglobal-webservice-maintenence.jpg"/>'; 
                }
                ...
                if(isset($csv2post_is_domainregistered) && $csv2post_is_domainregistered == true){
                    echo '<img src="'.WTG_C2P_URL.'fulledition/images/statusbanners/domainstatusbanners/csv-2-post-domainstatus-registered.jpg"/>';    
                }elseif(isset($csv2post_is_domainregistered) && $csv2post_is_domainregistered == false){ 
                    echo '<img src="'.WTG_C2P_URL.'fulledition/images/statusbanners/domainstatusbanners/csv-2-post-domainstatus-notregistered.jpg"/>';         
                }else{
                    echo '<img src="'.WTG_C2P_URL.'fulledition/images/statusbanners/domainstatusbanners/csv-2-post-domainstatus-unknown.jpg"/>';          
                }
