...
<div class="wrap">
    ...
    <p>Instructions for the settings page are available on my blog. <a href="http://www.csv2post.com/blog/instructions/using-csv-2-post-settings-page" title="Settings Page Instructions" target="_blank">Click to view CSV 2 POST settings page instructions</a>.</p>
