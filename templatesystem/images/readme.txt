...
The plugin can be provided in a package without images if the existence of these
images without rights to use them is a problem i.e. in a blog where the images may be displayed to the general
public and not just personal use. Where the display of the images appears to be commercial etc. Users are permitted 
to replace all image files with their own image files.