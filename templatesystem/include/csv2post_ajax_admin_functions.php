...
function csv2post_ajax_dataimportjob_requestupate() {
    ...
    $count_records_result = csv2post_sql_count_records_forfile( urldecode( 'csv2post_' . $_POST[ 'jobcode' ] ),$_POST['csvfilename'],csv2post_get_csvfile_id($_POST['csvfilename'],$_POST[ 'jobcode' ]) );
