...
function csv2post_ADDACTION_admin_init_registered_scripts() {
    ...
    wp_deregister_script( 'jquery-ui' );
        ...
        if($version == 'original'){
           ...
           // wp_register_script( 'jquery-ui', WTG_C2P_URL.'templatesystem/script/jquery-ui.js',array('jquery'));
        }elseif($version == 'latest'){ 
    ...
    if($version == 'original'){
        wp_register_script('jquery-multi-select',WTG_C2P_URL.'templatesystem/script/multi-select-basic/jquery.multi-select.js',array('jquery'));
    }elseif($version == 'latest'){ 
    ...
    // multi-select (lists, not the same as multiselect menus)
    if($version == 'original'){
        wp_register_script('jquery-cookie',WTG_C2P_URL.'templatesystem/script/jquery.cookie.js',array('jquery'));
    }elseif($version == 'latest'){ 
