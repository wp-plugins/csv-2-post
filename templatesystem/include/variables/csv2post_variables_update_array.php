...
#   Version 6.8.4    #
######################
$csv2post_upgrade_array['6.8.4']['warning'] = 'This version delivers this new installation related system for updating the plugins installation status so that it suits changes in the latest version. Please do not rely on it for this plugin update. Please backup your database if your blog has CSV 2 POST projects.';
// change 0
