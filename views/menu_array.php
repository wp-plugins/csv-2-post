...
$c2p_mpt_arr['main']['tabs'][$sub]['help'][2] = array(__('Author Options'), __('Create users in your blog and their associated posts will also be connected to them. The plugin can create users using the email address only.'));
$c2p_mpt_arr['main']['tabs'][$sub]['help'][3] = array(__('Generate Tags'), __('If you do not have a column of data suitable as pre-made tags then you can generate some using a body of text. Some options are provide to increase the quality of tags. The tags string length is the total characters of all tags when put together including commas which separate each word or phrase.'));
++$sub;
$c2p_mpt_arr['main']['tabs'][$sub]['active'] = true;
