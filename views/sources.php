...
class CSV2POST_Sources_View extends CSV2POST_View {
    ...
    public function setup( $action, array $data ) {
        ...
        if( isset( $c2p_settings['currentproject'] ) && $c2p_settings['currentproject'] !== false ) {
            ...
            $this->add_meta_box( 'sources-datasources', __( 'Sources Table', 'csv2post' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'datasources' ) );      
    ...
    */
    public function postbox_sources_datasources( $data, $box ) {    
        global $CSV2POST, $wpdb, $c2p_settings;
